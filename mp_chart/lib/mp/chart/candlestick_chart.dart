...
class CandlestickChart extends BarLineScatterCandleBubbleChart<CandlestickChartController> {
  const CandlestickChart(CandlestickChartController controller) : super(controller);
}

class CandlestickChartState extends BarLineScatterCandleBubbleState<CandlestickChart> {}
