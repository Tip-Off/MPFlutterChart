...
abstract class PainterUtils {
  static TextPainter create(TextPainter painter, String text, Color color, double fontSize,
    ...
    if (painter.text != null && (painter.text is TextSpan)) {
      ...
      return _create(
          text == null ? preText : text, color == null ? preColor : color, fontSize == null ? preFontSize : fontSize,
  ...
  static TextPainter _create(String text, Color color, double fontSize,
    ...
    return TextPainter(
        ...
        text: TextSpan(
            text: text, style: createTextStyle(color, fontSize, fontFamily: fontFamily, fontWeight: fontWeight)));
  }
