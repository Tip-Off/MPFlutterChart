...
// ignore: non_constant_identifier_names
  static final List<Color> VORDIPLOM_COLORS = [
...
// ignore: non_constant_identifier_names
  static final List<Color> JOYFUL_COLORS = [
...
// ignore: non_constant_identifier_names
  static final List<Color> MATERIAL_COLORS = [Color(0xFF2ecc71), Color(0xFFf1c40f), Color(0xFFe74c3c), Color(0xFF3498db)];

// ignore: non_constant_identifier_names
  static final List<Color> COLORFUL_COLORS = [
...
// ignore: non_constant_identifier_names
  static final List<Color> LIBERTY_COLORS = [
...
// ignore: non_constant_identifier_names
  static final List<Color> PASTEL_COLORS = [
